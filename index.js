...
const token = 'NTgyNDY5NjU4MDcwNzQ1MDg4.XOuRUg._TqFoP3tlCTmEi0pNgUwV0dfMas';
        ...
        switch(args[0]){
            case 'esl1':
                if(!message.member.roles.find(r => r.name === "Guest")) return message.channel.send("You do not have permissions")
                    ...
                    .addField('Main:', 'Friction.NLG, Angor.NLG, Jubiman.NLG, Jimmy-Egg.NLG')
